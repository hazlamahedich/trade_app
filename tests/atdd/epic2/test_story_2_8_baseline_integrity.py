"""ATDD: Story 2.8 — Mandatory Baseline Comparison & Integrity Checks.

Tests assert the expected end-state for Story 2.8.
Buy-and-hold baseline always shown, integrity checks detect impossible results,
IS label present on all results, regime stratification when data available.
"""
