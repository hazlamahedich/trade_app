...
class TestStory26TransactionCosts:
    ...
    @pytest.mark.test_id("2.6-ATDD-001")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-002")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-003")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-004")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-005")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-006")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-007")
    @pytest.mark.p1
    ...
    @pytest.mark.test_id("2.6-ATDD-008")
    @pytest.mark.p1
