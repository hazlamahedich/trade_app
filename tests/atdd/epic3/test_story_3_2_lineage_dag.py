...
Red-phase scaffolds. Tests assert the EXPECTED end-state for Story 3.2.
...
class TestStory32LineageDAG:
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_thread_shows_parent_child_chain(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage

        child_run_id = db_with_remix_chain._child_run_id
        lineage = get_lineage(db_with_remix_chain, child_run_id)
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_node_shows_run_id_and_key_metric(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_node_shows_parameter_change_from_parent(
        self, db_with_remix_chain
    ):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p1
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_node_shows_pre_mortem_prediction(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_is_immutable(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage

        parent_id = db_with_remix_chain._parent_run_id
        lineage = get_lineage(db_with_remix_chain, parent_id)
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_auto_narrative_appended_per_experiment(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p1
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_fork_point_recorded(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p2
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_for_root_experiment_has_no_parent(self, db_with_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage
    ...
    @pytest.mark.p2
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    def test_lineage_with_multiple_fork_depth(self, db_with_deep_remix_chain):
        from trade_advisor.experiments.lineage import get_lineage

        leaf_id = db_with_deep_remix_chain._leaf_run_id
        lineage = get_lineage(db_with_deep_remix_chain, leaf_id)
...
class TestStory32LineageWebAPI:
    ...
    @pytest.mark.p0
    @pytest.mark.skip(reason="RED: Story 3.2 not implemented")
    async def test_lineage_api_returns_dag(self, app_client, db_with_remix_chain):
        child_id = db_with_remix_chain._child_run_id
        response = await app_client.get(f"/api/experiments/{child_id}/lineage")
